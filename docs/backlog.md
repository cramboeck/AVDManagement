...
| 4 | Softwareinventar + winget-Gegencheck | Intune `detectedApps`; Bibliotheksskript `winget-updates` auf dem Geraet | Umgesetzt: je Geraet (Tab Software) Inventar, winget-Pruefung, winget-Inventar, Installieren/Aktualisieren/Deinstallieren als Job; tenantweit (Seite Software) alle Programme mit Versionen und Geraetezahl, Katalogstand aktuell/veraltet, Sammelaktion auf bis zu 25 Geraete je Job, Sperrliste mit Alerts. Offen: tenant-uebergreifende Sicht ueber alle Kunden, geschlossene CVEs je Update, Sammelaktion aus dem Update-Check heraus |
...
| 12 | Azure-VMs aus dem Portal verwalten und aus Vorlagen bereitstellen | ARM-Vorlagen, VM Contributor, Contributor auf Ressourcengruppe | V1 umgesetzt: Seite Azure VMs, Detail, Jobs Start/Stop/Neustart/Groesse, Bereitstellung aus der Vorlage windows-vm mit ARM-Validierung, Kostenschaetzung und versiegeltem Passwort. Offen (Plan): AVD-Sitzungshost-Vorlage mit Host-Pool-Registrierung, Bulk mit Namensmuster, Start/Stop-Zeitplaene, Loeschen, Bicep-Quellen, Kostenbericht |
...
| Exchange-Postfaecher | Graph reports/getMailboxUsage*, Graph mailboxSettings und messageRules, EXO-Worker fuer den Rest | Reports.Read.All, MailboxSettings.ReadWrite | Umgesetzt: Seite Exchange mit Groesse, Kontingent, Aktivitaet, Archiv (Snapshot 6 h); Postfachdetail mit Abwesenheit, Aliassen, Posteingangsregeln; Jobs Abwesenheit setzen, Weiterleitungsregel anlegen, Regel aktivieren/deaktivieren/loeschen; Weiterleitungs-Scan ueber alle Postfaecher. Exchange-Worker (E2) umgesetzt: Postfachdaten sammeln, Kontingente, Weiterleitung auf Postfachebene, Vollzugriff, Senden als, Archiv, Postfachtyp, Beweissicherung als Jobs mit Vorschau. Offen: Transportregeln, Outbound-Spam-Richtlinie, Aufbewahrungsrichtlinien, Verteilergruppen |
