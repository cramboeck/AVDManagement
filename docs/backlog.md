...
| 11 | Kommunikation der Clients: Ziele aus Defender Advanced Hunting | Defender for Endpoint Plan 2, `AdvancedQuery.Read.All` | Umgesetzt: Tab Verbindungen je Geraet und Abschnitt "Kommunikation der Clients" (extern/intern) auf der Netzwerkseite, je Ziel Host, Ports, Prozesse, Richtung, Geraetezahl. Defender for Business liefert keine Advanced-Hunting-Daten. Offen: Regelvorschlaege fuer die Firewall aus den Zielen, Zeitverlauf, Abgleich mit bekannten Microsoft-Endpunkten |
